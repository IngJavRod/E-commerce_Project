...
if (!producto) {
    ...
    contenedor.innerHTML = `
        <div class="row text-center align-items-stretch">
            ...
            <div class="col-md-4 text-start d-flex flex-column" id="detalle-recuadro">
                ...
                <div class="mt-auto">
                    <div class="mb-3">
                        <p class="mb-1 fw-bold">Tallas:</p>
                        <div id="tallas" class="d-flex flex-wrap gap-2">
                            ${(producto.tallas || []).map(talla => `
                                <button class="btn btn-outline-dark btn-sm talla-btn">${talla}</button>
                            `).join('')}
                        </div>
                    </div>
    ...
    // Evento para miniaturas (cambiar imagen principal)
    ...
    // Opcional: marcar talla seleccionada
